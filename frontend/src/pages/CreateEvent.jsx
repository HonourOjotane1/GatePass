  ...
  <div className="animate-in fade-in slide-in-from-right-4 duration-300">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
      <div className="space-y-2">
        <label className="text-sm font-bold text-slate-900">Event Name <span className="text-red-500">*</span></label>
        <input 
          type="text" 
       ...
       <div className="space-y-2">
        <label className="text-sm font-bold text-slate-900">Event Description <span className="text-red-500">*</span></label>
        <input 
          type="text" 
      ...
      <div className="space-y-2 relative">
        <label className="text-sm font-bold text-slate-900">Event Category <span className="text-red-500">*</span></label>
        <div className="relative">
          <select 
    ...
    <div className="space-y-3">
      <label className="text-sm font-bold text-slate-900">Event Cover Image <span className="text-red-500">*</span></label>
...
const Step2 = ({ form, update }) => (
  <div className="animate-in fade-in slide-in-from-right-4 duration-300">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
      <div className="space-y-2">
        <label className="text-sm font-bold text-slate-900">Event Start Date & Time <span className="text-red-500">*</span></label>
        <div className="relative">
          <input 
            type="text" 
      ...
      <div className="space-y-2">
        <label className="text-sm font-bold text-slate-900">Event End Date & Time <span className="text-red-500">*</span></label>
         <div className="relative">
          <input 
            type="text" 
            value={form.endDate}
      ...
      <div className="space-y-2">
        <label className="text-sm font-bold text-slate-900">Venue Name <span className="text-red-500">*</span></label>
        <input 
          type="text" 
       ...
       <div className="space-y-2">
        <label className="text-sm font-bold text-slate-900">Address <span className="text-red-500">*</span></label>
        <input 
          type="text" 
          value={form.address}
    ...
    <div className="flex items-center gap-4">
      ...
      >
        <div className={`w-4 h-4 rounded-full bg-white shadow-sm transform transition-transform duration-300 ${form.isVirtual ? 'translate-x-6' : 'translate-x-0'}`} />
      </button>
    </div>
  </div>
);
  ...
  if (form.accessType === 'ticketed') {
    return (
      <div className="animate-in fade-in slide-in-from-right-4 duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-900">Ticket Name <span className="text-red-500">*</span></label>
            <input 
              type="text" 
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-900">Price <span className="text-red-500">*</span></label>
            <input 
              type="text" 
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-900">Quantity <span className="text-red-500">*</span></label>
            <input 
              type="text" 
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-900">Description <span className="text-red-500">*</span></label>
            <input 
              type="text" 
        ...
        {tab === 'upload' ? (
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="text-[#6B4EFF] text-xs font-bold border border-[#6B4EFF]/30 px-4 py-2 rounded-lg hover:bg-[#6B4EFF]/5">Download Template</button>
            </div>
            ...
            <div className="border-2 border-dashed border-slate-200 rounded-2xl h-48 flex flex-col items-center justify-center bg-slate-50/50 hover:bg-slate-50 transition-colors cursor-pointer">
              ...
              <button className="mt-4 px-6 py-2 border border-slate-300 rounded-lg text-xs font-bold text-slate-600 bg-white">Browse</button>
            </div>
          </div>
        ) : (
  ...
  <div className="animate-in fade-in slide-in-from-right-4 duration-300">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-y-10 gap-x-4 mb-12">
      ...
      {form.accessType === 'invite' && (
        <ReviewItem label="RSVPs" value="300" /> 
      )}
    </div>
