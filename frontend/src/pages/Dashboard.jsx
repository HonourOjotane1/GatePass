...
//     <div className="w-12 h-12 bg-[#F9FAFB] rounded-2xl flex items-center justify-center text-xl border border-slate-50">
//       {icon}
//     </div>
//     <div>
//       <h4 className="text-2xl font-bold text-slate-900 leading-none mb-1">
//         {value}
//       </h4>
