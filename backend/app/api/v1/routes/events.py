...
from app.api.v1.schemas.event import (
    ...
    EventCreate, EventResponse, EventStatsResponse,
    DashboardStatsResponse, CoHostInvite, ShareableLinkResponse
)
...
from app.api.v1.services.events import (
    wizard_step1, wizard_step2, wizard_step3, wizard_step4,
    publish_event, save_draft, create_event,
    get_organizer_events, update_event_status,
    get_event_stats, get_dashboard_stats,
    invite_co_host, accept_co_host_invite,
    update_co_host_permission, remove_co_host,
    get_event_by_slug, get_shareable_link, _get_own_event
)
